...
const (
	FailureBadAlg               PKIFailureInfo = 0  // Unrecognized or unsupported Algorithm Identifier.
	FailureBadRequest           PKIFailureInfo = 2  // Transaction not permitted or supported.
	FailureDataFormat           PKIFailureInfo = 5  // The data submitted has the wrong format.
	FailureTimeNotAvailabe      PKIFailureInfo = 14 // The TSA's time source is not available.
	FailureUnacceptedPolicy     PKIFailureInfo = 15 // The requested TSA policy is not supported by the TSA.
	FailureUunacceptedExtension PKIFailureInfo = 16 // The requested extension is not supported by the TSA.
	FailureAddInfoNotAvailable  PKIFailureInfo = 17 // The additional information requested could not be understood or is not available.
	FailureSystemFailure        PKIFailureInfo = 25 // The request cannot be handled due to system failure.
)
