...
public class TestDay01 {
    ...
    static String example1 = "1abc2\n" +
            "pqr3stu8vwx\n" +
            "a1b2c3d4e5f\n" +
            "treb7uchet";

    static String example2 = "two1nine\n" +
            "eightwothree\n" +
            "abcone2threexyz\n" +
            "xtwone3four\n" +
            "4nineeightseven2\n" +
    ...
    public void testPart1() throws Exception {
        assert procLines(example1, false) == 142;
        System.out.println("Challenge A: " + procLines(challenge, false));
    }

    @Test
    public void testPart2() throws Exception {
        assert procLines(example2, true) == 281;
        System.out.println("---------");
        System.out.println("Challenge B: " + procLines(challenge, true));
    }

    static int procLines( String input, boolean useNames ) throws Exception {
        String[] lines = input.split("\n");
        int sum = 0;
        for (String line : lines) {
            int value = procLine(line, useNames);
    ...
    static String[] numNames = new String[]{ "one", "two", "three", "four", "five", "six", "seven", "eight", "nine"};
    static int procLine( String line, boolean useNames ) {
        int firstDigit = -1;
        int lastDigit = -1;
        for (int i = 0; i < line.length(); i++) {
            ...
            for( int n = 0; n < numNames.length; n++) {
                String numName = numNames[n];
                try{
                    if( line.substring(i, i + numName.length()).equals(numName) ) {
                        if( firstDigit == -1 ) {
                            firstDigit = n+1;
                        } else {
                            lastDigit = n+1;
    ...
    static String challenge = "mxmkjvgsdzfhseightonetwoeight7\n" +
